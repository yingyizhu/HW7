<%@ Page Title="" Language="VB" MasterPageFile="~/swap.master" AutoEventWireup="false" CodeFile="edititem.aspx.vb" Inherits="admin_edititem" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">Edit Items
</asp:Content>


<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_yzhu16HW7_swap %>" DeleteCommand="DELETE FROM [yzhu16HW7_swap] WHERE [ItemID] = @ItemID" InsertCommand="INSERT INTO [yzhu16HW7_swap] ([ItemrName], [OwnerName], [ItemDesc], [Wanted], [ContactInfo], [Location], [Donate], [Price]) VALUES (@ItemrName, @OwnerName, @ItemDesc, @Wanted, @ContactInfo, @Location, @Donate, @Price)" SelectCommand="SELECT * FROM [yzhu16HW7_swap] WHERE ([ItemID] = @ItemID)" UpdateCommand="UPDATE [yzhu16HW7_swap] SET [ItemrName] = @ItemrName, [OwnerName] = @OwnerName, [ItemDesc] = @ItemDesc, [Wanted] = @Wanted, [ContactInfo] = @ContactInfo, [Location] = @Location, [Donate] = @Donate, [Price] = @Price WHERE [ItemID] = @ItemID">
            <DeleteParameters>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="ItemID" DataSourceID="SqlDataSource1" Height="50px" Width="125px" CssClass="cssdetailsview"
...
<FieldHeaderStyle CssClass="fieldheader"></FieldHeaderStyle>
            <Fields>
                ...
                <asp:TemplateField HeaderText="*Item Name" SortExpression="ItemrName">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("ItemrName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="* Item Desc" SortExpression="ItemDesc">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("ItemDesc") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Wanted" SortExpression="Wanted">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Wanted") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>


                <asp:TemplateField HeaderText="* Contact Info" SortExpression="ContactInfo">
                    <EditItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("ContactInfo") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="* Donate('Y'or'N')" SortExpression="Donate">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label7" runat="server" Text='<%# Bind("Donate") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

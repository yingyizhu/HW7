<%@ Page Title="" Language="VB" MasterPageFile="~/swap.master" AutoEventWireup="false" CodeFile="uswap.aspx.vb" Inherits="uswap" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">For Swap
</asp:Content>
...
PagerStyle-CssClass="pgr">
            <Columns>
                ...
                <asp:HyperLinkField Text="More Details" DataNavigateUrlFields="ItemID" DataNavigateUrlFormatString="itemdetail.aspx?ItemID={0}" />
            </Columns>
        </asp:GridView>
